/*! ReactNativeWebRTC - v0.1.01 - Fri Aug 16 2019 15:40:42 GMT+0800 (Singapore Standard Time) */
...
Skylink.prototype._createPeerConnection = function(targetMid, isScreenSharing, cert) {
  ...
  try {
    ...
    pc = new (self._initOptions.useEdgeWebRTC && window.msRTCPeerConnection ? window.msRTCPeerConnection : window.RTCPeerConnection)(constraints, optional);
  } catch (error) {
...
Skylink.prototype.getPeerInfo = function(peerId) {
  ...
  if (typeof peerId === 'string' && typeof this._peerInformations[peerId] === 'object') {
    ...
    //TODO:@avi: passing null arguments.
...
Skylink.prototype._doAnswer = function(targetMid) {
  ...
  pc.createAnswer()
      .then((answer)=> onSuccessCbFn(answer))
      .catch(() => onErrorCbFn);
};
...
Skylink.prototype._requestServerInfo = function(method, url, callback, params) {
  ...
  //
  // console.log("in _requestServerInfo, waiting for response")
  // var self = this;
  // var retries = 0;
  // var response = {
  //   "success": true,
  //   "pc_constraints": "{\"optional\": [{\"DtlsSrtpKeyAgreement\": true}]}",
  //   "media_constraints": "{\"mandatory\":{\"maxWidth\":640,\"maxHeight\":480},\"optional\":[]}",
  //   "bandwidth": {
  //     "audio": 50,
  //     "video": 256,
  //     "data": 1638400
  //   },
  //   "offer_constraints": "{\"optional\": [], \"mandatory\": {\"MozDontOfferDataChannel\": true}}",
  //   "cid": "SkyWay00000001",
  //   "room_key": "3b91ad071c9d412130ace52cdbcb0b0858a000c1_api_test",
  //   "start": "2019-07-16T04:23:41.708Z",
  //   "len": "2",
  //   "roomCred": "FznDOxrc4F/r4zZeSJp8rEVQJPY=",
  //   "apiOwner": "dinaw",
  //   "username": "0aaa5692pz3",
  //   "userCred": "DqW4m3hgD2t6llVpgYwOdAzEJGY=",
  //   "timeStamp": "2019-07-16T04:23:45.762Z",
  //   "displayName": "0aaa5692pz3",
  //   "ipSigserver": "signaling-legacy.temasys.com.sg",
  //   "protocol": "http",
  //   "httpPortList": [80, 3000],
  //   "httpsPortList": [443, 3443],
  //   "portSigserver": 80,
  //   "isPrivileged": false,
  //   "autoIntroduce": true,
  //   "hasMCU": false,
  //   "enable_stats_config": false
  // }
  //callback(response);
  //
      ...
      var onSuccessCbFn = function (stream) {
        ...
        var onAudioSuccessCbFn = function (audioStream) {
          try {
            ...
            pc.addStream(stream.getVideoTracks()[0]);
        ...
        var updateStreamFn = function (updatedStream) {
          if (updatedStream ? (pc.localStreamId ? updatedStream.id !== pc.localStreamId : true) : true) {
            ...
            if (updatedStream) {
              ...
              //     return;
              //   }
              //   console.log("This is value of pc", pc);
              //   //TODO:@avi adding addstream here
